...
/**
 * this is going to be an isnatance method for user, to compare a password with the stored password 
 * 
 * @param  plainPassword  -> input password given by user in sign in in request
