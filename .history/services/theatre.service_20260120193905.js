...
const getAllTheatres = async (queryParams) => {
    ...
    if (queryParams.pincode) {
        query.pincode = queryParams.pincode;
    }
    ...
    return Theatre.find(query, null, options).populate('movies');
};
